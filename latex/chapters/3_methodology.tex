...
- Automation of model building, in contrast to statistical inference / models
- Uses algorithms to iteratively learn
- Find hidden relations / context / connections / patterns, without explicitly programming it
- Generalization
