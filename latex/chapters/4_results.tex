...
This is a deviation of around 0.3 for the \gls{rmse}.
...
To put it in perspective, if the center is used as prediction, it is off by maximal $0.5$, if the expected user click is always at the border.
