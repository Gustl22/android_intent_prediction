...
In theory that should improve the models performance, as the model \tb{FeaturesClickShifted} then can choose the click based on the elements shown on the current screen while predicting.
