...
\newacronym[description={}]{gps}{GPS}{Global Positioning System}
\newacronym[description={A stochastical utility based on adaptive gradiend descent to optimize a function}]{adam}{Adam}{Adaptive Moment Estimation}

\newglossaryentry{gl-accuracy}{name={accuracy}, description={Probability of correctness of a classification}}
\newglossaryentry{gl-one-hot}{name={one-hot}, description={A combination of multiple binary values, where one of them is \tb{1} and the others are \tb{0}}}
