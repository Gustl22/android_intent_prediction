...
\usepackage[
  title={Intent Prediction with Vectorized Sequential UI Tree Data}, % Do not forget to capitalize your title correctly, you may use the following page to help you: https://capitalizemytitle.com/
...
\include{chapters/2_related_work.tex}

\include{chapters/3_study_design.tex}
